...
export function Panel({ children, title, headerAction, variant = 'default', className }: PanelProps) {
  return (
    <div
    ...
    >
      {(title || headerAction) && (
        <div className="px-4 py-2 border-b border-cyan-dim flex items-center justify-between gap-2">
          {title && (
